<nav class="navbar navbar-expand-lg navbar-light bg-warning sticky-top">
    <nav class="navbar navbar-expand navbar-light bg-warning sticky-top">
      ...
      <h6><a class="navbar" href="../index.php">MercaSeguro </a></h6>
      <?php
    ...
    <div class="d-blockd-sm-none d-md-none" ><h3 class="navbar-brand">Bienvenido</h3></div>
    <div class="collapse navbar-collapse"  id="navbarColor02">
      ...
      <div class="d-none d-sm-none d-md-none d-lg-block d-xl-block">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../registry_user_login/crear_usuario.php">Crea tu cuenta</a>
        </li>
