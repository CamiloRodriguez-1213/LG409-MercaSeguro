<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center">
      ...
      <li class="page-item <?php echo $_GET['pagina'] <= 1 ? 'disabled' : '' ?>">
        ...
        <a class="page-link" href="mis_productos.php?pagina=<?php echo $_GET['pagina'] - 1 ?>&estado=<?php echo $estado ?>" tabindex="-1" aria-disabled="true">
          Anterior
      ...
      <?php for ($i = 0; $i < $mostrar_paginas; $i++) : ?>
        ...
        <li class="page-item <?php echo $_GET['pagina'] == $i + 1 ? 'active' : '' ?>">
          ...
          <a class="page-link" href="mis_productos.php?pagina=<?php echo $i + 1 ?>&estado=<?php echo $estado ?>">
            <?php echo $i + 1 ?>
          </a>
        </li>
      <?php endfor ?>
      ...
      <li class="page-item <?php echo $_GET['pagina'] >= $mostrar_paginas ? 'disabled' : '' ?>">
        ...
        <a class="page-link" href="mis_productos.php?pagina=<?php echo $_GET['pagina'] + 1 ?>&estado=<?php echo $estado ?>" tabindex="-1" aria-disabled="true">Siguiente</a>
      </li>
    </ul>
  </nav>