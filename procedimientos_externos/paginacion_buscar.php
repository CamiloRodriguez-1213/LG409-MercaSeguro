...
$busqueda=trim ( $busqueda);
        ...
        $sql = "SELECT * FROM productos where nombre_producto LIKE '%$busqueda%' OR descripcion_producto LIKE '%$busqueda%' AND estado='activo' ";
        ...
        $sql_paginas = "SELECT * FROM productos where nombre_producto LIKE '%$busqueda%' OR descripcion_producto LIKE '%$busqueda%'  AND estado='activo' LIMIT $inicio_res,$num_x_pag";
