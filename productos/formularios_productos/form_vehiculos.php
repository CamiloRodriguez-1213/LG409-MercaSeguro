		...
		<input type="text" name="crear_producto" hidden>
			<fieldset>
				...
				<div class="container ">
					...
					<small><h6><b>Nombre/marca vehículo <a style="color: red;">*</a></b></h6></small>
						<input type="text" required class="form-input3" name="nombre" style="width: 14rem; height:35px" required placeholder="Marca(ejemploXXXX)">
                    ...
                    <small><h6><b>Descripción <a style="color: red;">*</a></b></h6></small>
                            ...
                            <div id="con-editor">
                            		<div id="editor">
                                        ...
                                        <textarea required style="width: 100%;height: 200px;background-color: #fcfcfc;justify-content: start;"  placeholder="Describe tu vehículo &#10;&#10;&#10; Ejemplo(estado, documentación)" name="descripcion"  ></textarea>
			...
			<fieldset>
				...
				<div class="form-group ">
					<div class="row justify-content-center align-items-center">
						<div class="form-group">
						<?php
				$sql = "SELECT id, nombre_cat FROM categorias_productos WHERE id_clase_producto=3";
			...
			<fieldset><br><br>
				...
				<div class="form-group">
					...
					<input required type="file" aling name="imagen" id="file-upload" accept="image/*"/>
