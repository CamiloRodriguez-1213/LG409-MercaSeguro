...
<body>
	...
	<div class="container " style="max-width: 700px">
		...
		<input type="text" name="crear_producto" hidden>
			<fieldset>
				...
				<div class="container ">
					...
					<small><h6><b>Nombre <a style="color: red;">*</a></b></h6></small>
						<input type="text" required class="form-input3" name="nombre" style="width: 14rem; height:35px" required placeholder="Inmueble ejemplo">
                    ...
                    <small><h6><b>Descripción <a style="color: red;">*</a></b></h6></small>
                            ...
                            <div id="con-editor">
                            		<div id="editor">
                                        ...
                                        <textarea required style="width: 100%;height: 200px;background-color: #fcfcfc;justify-content: start;"  placeholder="Describe tu inmueble" name="descripcion"  ></textarea>
			...
			<fieldset>
				<?php
				$sql = "SELECT id, nombre_cat FROM categorias_productos where id_clase_producto=4";
				...
				<label>$<input required type="text" class="form-input3" name="precio" style="width: 14rem;" placeholder="ej. 13.000"></label><br><br>
