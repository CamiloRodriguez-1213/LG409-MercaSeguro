...
<body>
	...
	<div class="container " style="max-width: 700px">
		...
		<input type="text" name="crear_producto" hidden>
			<fieldset>
				<h2>¿Que servicio brindas?</h2>
				<div class="container ">
					<div class="form-group mt-3"><br>
					<small><h6><b>Nombre <a style="color: red;">*</a></b></h6></small>
						<input type="text" required class="form-input3" name="nombre" style="width: 14rem; height:35px" required placeholder="Servicio ejemplo">
                    ...
                    <small><h6><b>Descripción <a style="color: red;">*</a></b></h6></small>
                            ...
                            <div id="con-editor">
                            		<div id="editor">
                                        ...
                                        <textarea required style="width: 100%;height: 200px;background-color: #fcfcfc;justify-content: start;"  placeholder="Describe tu Servicio" name="descripcion"  ></textarea>
			...
			<fieldset>
				<?php
				$sql = "SELECT id, nombre_cat FROM categorias_productos where id_clase_producto=2";

				$result = DB::query($sql);		

				?>
				<h2>Valor y categoria de tu servicio</h2>
				<div class="form-group"><br>
				<small><h6><b>Valor <a style="color: red;">*</a></b></h6></small>
				<label>$<input type="text" required class="form-input3" name="precio" style="width: 14rem;" placeholder="ej. 13.000"></label><br><br>
				
				</div>
				<div class="form-group ">
					<div class="row justify-content-center align-items-center">
						<div class="form-group">
						<small><h6><b>Categoria <a style="color: red;">*</a></b></h6></small>
							<select required class="form-control " name="cbx_categoria" id="cbx_categoria">
			...
			<fieldset><br><br>
				<h2>Foto del producto<a style="color: red;">*</a></h2>
				<small><h6><b>¿Que representa tu servicio? </b></h6></small>
